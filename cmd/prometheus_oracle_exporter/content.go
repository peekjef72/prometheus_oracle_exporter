...
const (
	docsUrl   = "https://github.com/peekjef72/prometheus_oracle_exporter#readme"
	templates = `
    {{ define "page" -}}
      <html>
      <head>
...
func ConfigHandlerFunc(metricsPath string, exporter prometheus_oracle_exporter.Exporter) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
