...
func ExporterHandlerFor(exporter prometheus_oracle_exporter.Exporter) http.Handler {
...
func contextFor(req *http.Request, exporter prometheus_oracle_exporter.Exporter) (context.Context, context.CancelFunc) {
